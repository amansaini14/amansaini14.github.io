      ...
      >
        <div className="grid gap-12 lg:gap-16 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          ...
          <div>
            ...
            <motion.p
              className="mt-10 max-w-2xl text-xl sm:text-2xl text-white/70 leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.4 }}
            >
              ML engineer shipping{" "}
              <span className="text-white">generative AI</span> at Apple.
              Previously Grammarly, Twitter, Microsoft. I train and optimize
              LLMs — post-training, RL, evaluation.
            </motion.p>
            ...
            >
              ...
              <a
                href={PROFILE.resume}
                className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 backdrop-blur text-white px-6 py-3 font-medium text-sm hover:bg-white/10 transition-colors"
              >
                Résumé ↓
              </a>
              <a
